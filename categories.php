...
<?php
    ...
    while($data = mysqli_fetch_array($res)){
        ...
        $str .= "<td>
                     <a href='categories_delete.php?=&category_id=$data[category_id]' onClick='return confirm(\"Anda Yakin Ingin Mengapus Buku $data[category_name]\")'><button style='width:100px;background-color:rgba(240, 38, 55, 0.884);color:white;font-weight:bold;padding:4px;'>HAPUS</button></a></td>";
        $str .= "</tr>";
