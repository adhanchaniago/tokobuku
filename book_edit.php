...
$sql = "SELECT * FROM tbl_mybooks WHERE book_id = '$book_id'";
$res = mysqli_query($conn,$sql);
$data = mysqli_fetch_array($res);
?>

<form method="POST" enctype="multipart/form-data" action="book_edit_proses.php">
...
<table class="table" align="center">
    ...
    <tr>   
        <td>Book Image</td>
        <td>:</td>
        <td><input type="file" name="img"><img src="image/<?=$data['img']?>" width=50px height=50px></td>
    </tr>
    <tr><td></td>
        <td></td>
        <td colspan="3"> 
            <input type="submit" name="add" value="UPDATE" style='width:100px;background-color:rgb(26, 53, 207);color:white;font-weight:bold;padding:4px;'>
